                        ...
                        @foreach($flights as $flight)
                            ...
                            <summary class="cursor-pointer list-none px-4 py-4 grid grid-cols-12 gap-2 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                ...
                                <div class="flex items-center justify-between px-4 py-4 bg-white dark:bg-gray-700 overflow-hidden shadow-sm rounded-b-lg">
                                    ...
                                    @else
                                    <a href="{{ route('login') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Buy</a>
                                    @endauth
                                </div>
                            </details>
                        @endforeach       
